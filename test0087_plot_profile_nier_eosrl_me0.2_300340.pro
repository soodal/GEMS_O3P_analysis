...
pro plot_softcal_rad, syntheticwav, l1cradwav, $
  eosrl_fitspec, synthetic_simrad, $
  nier_fitspec, nier_l1cradwav, $
  xpos, ypos, cldstr, suffix=suffix, outfilepath=outfilepath
  ...
  if not keyword_set(outfilepath) then begin
  ...
  p1 = plot(syntheticwav[ypos, *], eosrl_fitspec[xpos, ypos, *], /buffer, $
    axis_style=1, $
  ...
  p3 = plot($
      reform(nier_l1cradwav[xpos, ypos, *]), reform(nier_fitspec[xpos, ypos, *]), $
      /buffer, $
      axis_style=0, $
      name='GEMS NIER', $
      color=[228, 160, 0], $
  ...
  eosrl_data = (eosrl_fitspec[xpos, ypos, *] - synthetic_simrad[xpos, ypos, *])/$
      synthetic_simrad[xpos, ypos, *]*100

  nier_data = (nier_fitspec[xpos, ypos, *] - synthetic_simrad[xpos, ypos, *])/$
      synthetic_simrad[xpos, ypos, *]*100

  ;idx = where(data lt 0, /null)
  ;data[idx] = 0
  p4 = barplot(reform(syntheticwav[ypos, *]), reform(eosrl_data), $
    /buffer, $
    axis_style=0, $
    name='(EOSRL-Synthetic) \slash Synthetic[%]', $
    ;symbol='s', $
    yrange=[-100, 100], $
    xrange=[300, 340], $
    position=pos, $
  ...
  ;data[idx] = 0
  p5 = barplot($
    syntheticwav[ypos, *], nier_data, $
    /buffer, $
    axis_style=0, $
    name='(NIER-Synthetic) \slash Synthetic[%]', $
    ;symbol='s', $
    yrange=[-100, 100], $
    xrange=[300, 340], $
    position=pos, $
  ...
  yaxis1 = axis('Y', LOCATION='left', yrange=yrange, TARGET=p1, $
    color='red', title='Normalized Radiance')
  ...
  outfilepath = './plot/EOSRL/'
  pngfile = outfilepath + 'gems_merra2_synthetic_simrad_x' + sXidx +'_y' + syidx +  suffix + '.png'
...
;if file_test(datafile) then begin
  ...
  ; GEMS O3P NIER
  ;=============================================================================
  search_str = '/data/private/soodal/EOSRL/NIER/GK2_GEMS_L2_O3P_20210329_0345_wli300_ML_prec000000_adj_sig_0.2_ozminmax2x_BIN4x4.nc'
  ...
  ; GEMS O3P EOSRL
  ;=============================================================================
  search_str = '/data/private/soodal/EOSRL/EOSRL/GK2_GEMS_L2_O3P_20210329_0345_wli300_ML_prec000000_adj_sig_0.2_ozminmax2x_BIN4x4.nc'
  ...
  search_str = '/data/private/soodal/softcal_test/corrected/model_300_340/GK2_GEMS_L2_O3P_20210329_0345_winliminit300_prec000000_climML_b4x4_o20211129T141817Z_clima_maxiter10_ecf0.nc'
  ...
  for icity=0, n_elements(cities_lat) -1 do begin
    ...
    if pixidx ne -999 then begin 
      ...
      ; ===========================================================================
        ...
        p2.save, outputpath + '300340_prec0.2_adj_sig_x' + string(pixindices[0], format='(i03)') +  $
        ...
        plot_softcal_rad, syntheticwav, l1cradwav, $
          ...
          pixindices[0], pixindices[1], cldstr, suffix='_me0.2_adj_sig_300340', $
          outfilepath='./plot/EOSRL/me0.2_adj_sig_300_340/'
...
for icf = 0.05, icf_final, 0.05 do begin
  ...
  ;outputpath = outputpath + 'point_profile/'
      ...
      p2.save, outputpath + 'profile_me0.2_adj_sig_300340_x' + string(pixindices[0], format='(i03)') +  $
  ...
  if n_elements(idx) ge 1 then begin
    ...
    for ip = 0, n_elements(idx)-1 do begin
      ...
      if indices[0] eq 91 then begin
        ...
        outfilepath='./plot/EOSRL/me0.2_adj_sig_300_340/'
        pngfile = outfilepath + 'gems_merra2_synthetic_simrad_me0.2_adj_sig_ecf' + sicf0 +'-' + sicf1 + $
