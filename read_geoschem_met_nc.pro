...
;
;====================================================================================;
FUNCTION read_geoschem_met_nc, file=file, param=param, onlyp=onlyp
...
;;=============================================================================
  ...
  ;; Read Single Variables ; time, lev, ilev, lat, lon, hyam, hybm, hyai, hybi, PO
  FOR i=0,nvars-1 DO BEGIN
    var_struct=NCDF_VARINQ(nid,i)
    var_name=var_struct.name
    var_ndim=var_struct.ndims
    IF var_ndim LE 1 THEN BEGIN
...
;;=============================================================================
  ...
  FOR ip=0,np-1 DO BEGIN
    ...
    NCDF_VARGET,nid,var_name,var
      ...
      ndims[ip]=N_ELEMENTS(SIZE(var,/DIM))
...
;;=============================================================================
  ...
  FOR ip=0,np-1 DO BEGIN
    IF ndims[ip] GT 3 THEN BEGIN
      dum=EXECUTE('outdat[*,*,*,*,ip]='+param[ip])
    ENDIF ELSE BEGIN
      dum=EXECUTE('outdat[*,*,0,*,ip]='+param[ip])
    ENDELSE 
  ENDFOR
