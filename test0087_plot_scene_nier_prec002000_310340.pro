...
for i=0, n_elements(jd_list)-1 do begin
  ...
  fn = '/home/soodal/data/EOSRL/me/GK2_GEMS_L2_O3P_20210329_0345_wli310_ML_prec002000_ozminmax2x_NIER_BIN4x4.nc'
  ...
  for i = 0, n_elements(filelist)-1 do begin
    ...
    ds_plot_gemso3p_scene, filelist[i], $
        outputpath='./plot/', project='EOSRL', sub='me002000_310_340_NIER'
  endfor
endfor
