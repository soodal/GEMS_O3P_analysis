...
scp_dest = 'soodal@164.125.38.179:/home/soodal/works/plot/fitres'
...
;print,wavpath
wavfn = outputpath + '/wavtext/waves_310340.txt'
readcol, wavfn, wav
...
leg = legend(target=[p1, p2], pos=leg_pos)
pngfile = './plot/fitting_residual_' + date + '_' + fitrange + '_latlt20.png'
...
;leg = legend(target=[p0, p1, p2, p3, pap], pos=leg_pos)
leg = legend(target=[p1, p2], pos=leg_pos)
pngfile = './plot/fitting_residual_' + date + '_' + fitrange + '_20gelatlt40.png'
p1.errorbar_color='indian_red'
p1.errorbar_capsize=0.1
p1.title.font_size=16
p1.save, pngfile
...
;leg = legend(target=[p0, p1, p2, p3, pap], pos=leg_pos)
leg = legend(target=[p1, p2], pos=leg_pos)
pngfile = './plot/fitting_residual_' + date + '_' + fitrange + '_latlt20_mae.png'
p1.errorbar_color='indian_red'
p1.errorbar_capsize=0.1
p1.title.font_size=16
p1.save, pngfile
...
;leg = legend(target=[p0, p1, p2, p3, pap], pos=leg_pos)
leg = legend(target=[p1, p2], pos=leg_pos)
pngfile = './plot/fitting_residual_' + date + '_' + fitrange + '_20gelatlt40_mae.png'
p1.errorbar_color='indian_red'
p1.errorbar_capsize=0.1
p1.title.font_size=16
p1.save, pngfile
...
;leg = legend(target=[p0, p1, p2, p3, pap], pos=leg_pos)
leg = legend(target=[p1, p2], pos=leg_pos)
pngfile = './plot/fitting_residual_' + date + '_' + fitrange + '_latlt20_rmse.png'
p1.errorbar_color='indian_red'
p1.errorbar_capsize=0.1
p1.title.font_size=16
p1.save, pngfile
...
;leg = legend(target=[p0, p1, p2, p3, pap], pos=leg_pos)
leg = legend(target=[p1, p2], pos=leg_pos)
pngfile = './plot/fitting_residual_' + date + '_' + fitrange + '_20gelatlt40_rmse.png'
p1.errorbar_color='indian_red'
p1.errorbar_capsize=0.1
p1.title.font_size=16
p1.save, pngfile
