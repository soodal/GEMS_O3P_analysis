...
scp_dest = 'soodal@164.125.38.179:/home/soodal/WindowsHome/Pictures/scp/' $
  ...
  + fitrange + '_' + L1Cmaker + '_sum_tropo'
...
p1 = scatterplot(lon[o3layer_geolocidx], lat[o3layer_geolocidx], $
  ...
  symbol='dot', $
  sym_size=0.7, $
  title='O3 ' + strpres + '-1000 hPa (sum) EOSRL L1C ' + fit_range + ' nm fitting', $
    axis_style=0)
...
t = text(0.4, 0.025, 'Dae Sung Choi, ' + isodate)
pngfile = './plot/gems_l2_cao3_310340_EOSRL_'+strpres+'-1000hPa_sum.png'
