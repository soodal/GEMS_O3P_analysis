...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
MODULE Share_MOD_Constants_Variables 
...
!-------------------------------------------------------------------------------
SUBROUTINE GEMS_Share_Init_GlobalConstants
    USE NumTimes
    IMPLICIT NONE
    INTEGER :: nline
    INTEGER :: rc
 ...
 ! Size for L2 dataset
    ...
    gci_nwavel4_l2             = 23
    gci_nxtrack_l2             = 60
    gci_nxtrack2_l2            = 30   ! geun  999 -> 30 for sliced data 
    gci_nlayer                 = 24
    gci_nlayer2                = 11
!    gci_nlayerp = 777
...
END SUBROUTINE GEMS_Share_Init_GlobalConstants

SUBROUTINE GEMS_Share_Init_GlobalConstants2( ctl_fpath )
    USE NumTimes
    IMPLICIT NONE
    INTEGER :: nline
    INTEGER :: rc
...
END SUBROUTINE GEMS_Share_Init_GlobalConstants2

SUBROUTINE GEMS_Share_Init_GlobalConstants3( ctl_fpath )
    USE NumTimes
    IMPLICIT NONE
...
END SUBROUTINE GEMS_Share_Init_GlobalConstants3

END MODULE Share_MOD_Constants_Variables
