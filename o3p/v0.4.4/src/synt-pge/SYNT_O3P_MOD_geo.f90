...
CONTAINS
  ...
  SUBROUTINE SYNT_O3P_prep_geo ( ny, offline, pge_error_status )
  ...
  USE SYNT_data_module,         ONLY: synt_geo, geo_group 
  ...
  RETURN
  END SUBROUTINE SYNT_O3P_prep_geo
...
END MODULE SYNT_O3P_geo_module
