...
input_residual_fp = '/data/private/soodal/20210322_residuals/residuals/'
...
for dt in daterange:
    ...
    input_fl = glob.glob(input_residual_fp + 'GK2B_GEMS_L2_O3P_' + yyyy + mm + dd + '_' + hh + mi +
