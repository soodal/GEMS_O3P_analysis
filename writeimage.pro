...
endcase
 ...
 cgdisplay,800,600
    title = 'OMI SAO'
    levels = findgen(21)*2
    cgplot,fltarr(10,10),/nodata,yr=[1000,0.1],/ylog,$
    ...
    nlevels =21
    cgcontour,data.omi,data.omilon,pmid_omi,/overplot,c_colors=indgen(21),$;bytscl(levels,min=levels[0],m
               levels=levels,$
              /cell_fill  
 ;colorbar
  ...
  cfmt = '(I3)'
  charsize=1.3
  ;cgColorbar, Range=[min(levels),Max(levels)], $
 ...
 cgdisplay,800,600
    ...
    cgloadct,33,ncolors=22,bottom=0
    nlevels =21
    cgcontour,o3prfs,data.omilon,pmid_gems,/overplot,c_colors=indgen(21),$;bytscl(levels,min=levels[0],m
               levels=levels,$
              /cell_fill  
 ;colorbar
  cbpos = [0.82, 0.15, 0.85,0.95]
 ...
 cgdisplay,800,600
    ...
    cgloadct,33,ncolors=22,bottom=0
    nlevels =21
    cgcontour,data.apri,data.omilon,pmid_gems,/overplot,c_colors=indgen(21),$;bytscl(levels,min=levels[0],m
               levels=levels,$
              /cell_fill  
 ;colorbar
  cbpos = [0.82, 0.15, 0.85,0.95]
