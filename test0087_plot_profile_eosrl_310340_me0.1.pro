...
search_str = '/data/private/soodal/EOSRL/' + $
  'GK2_GEMS_O3P_' + datetime_str + '_*310340_me0.1.nc.debug.nc'
...
; GEMS O3P Synthetic
;=============================================================================
search_str = '/data/private/soodal/softcal_test/corrected/model_310_340/GK2_GEMS_L2_O3P_20210329_0345_winliminit310_prec000000_climML_b4x4_*.nc'
  ...
  ;for icity=0, n_elements(cities_lat) -1 do begin
    ...
    ;if pixidx ne -999 then begin 
      ...
      ; ===========================================================================
        ...
        print, 'sav'
        outputpath = './plot/EOSRL/310_340/20210329_0345/point_profile/'
        ...
        p2.save, outputpath + '310340_me0.1_eosrl_x' + string(pixindices[0], format='(i03)') +  $
