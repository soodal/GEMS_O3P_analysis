...
for i=0, n_elements(jd_list)-1 do begin
  ...
  fn = '/home/soodal/data/NIER/300340/GK2_GEMS_L2_O3P_20210329_0345_wli300_ML_prec000000_ozminmax2x_BIN4x4.nc'
  ...
  for i = 0, n_elements(filelist)-1 do begin
    ...
    ds_plot_gemso3p_scene, filelist[i], $
        outputpath='./plot/', project='NIER', sub='2xozminmax_300_340_NIER'
  endfor
endfor
