    ...
    ;if pixidx ne -999 then begin 
      ...
      ;; ===========================================================================
        ...
        ;plot_softcal_rad, syntheticwav, l1cradwav, $
          ...
          ;outfilepath='./plot/EOSRL/me0.2_310_340_debug/'
...
p2.save, outputpath + 'profile_me0.5_310340_x' + string(pixindices[0], format='(i03)') +  $
    '_y' + string(pixindices[1], format='(i03)')  + '_debug.png'
p2.close
...
;plot_softcal_rad, syntheticwav, l1cradwav, $
  ...
  ;nier_gems_fitspec, nier_l1cradwav, $
  ;pixindices[0], pixindices[1], cldstr, suffix='_me0.2_adj_sig_310340_debug', $
  ;outfilepath='./plot/EOSRL/me0.2_adj_sig_310_340_debug/'
...
indices = [91, 376]
  ...
  outfilepath='./plot/EOSRL/me0.5_310_340_debug/'
  if not file_test(outfilepath) then begin
    file_mkdir, outfilepath
  endif
  pngfile = outfilepath + 'gems_merra2_synthetic_simrad_me0.5_ecf' + $
    '_x' + string(indices[0], format='(i03)') + $
    '_y' + string(indices[1], format='(i03)') + '_debug.png'
