...
pro plot_softcal_rad, syntheticwav, l1cradwav, $
  ...
  xpos, ypos, cldstr, suffix=suffix
...
;if file_test(datafile) then begin
  ...
  ; GEMS O3P NIER
  ;=============================================================================
  search_str = '/data/private/soodal/EOSRL/me/GK2_GEMS_L2_O3P_20210329_0345_wli310_ML_prec001500_ozminmax2x_NIER_BIN4x4.nc'
  ...
  ; GEMS O3P EOSRL
  ;=============================================================================
  search_str = '/data/private/soodal/EOSRL/me/GK2_GEMS_L2_O3P_20210329_0345_wli310_ML_prec001500_ozminmax2x_EOSRL_BIN4x4.nc'
  ...
  for icity=0, n_elements(cities_lat) -1 do begin
    ...
    if pixidx ne -999 then begin 
      ...
      ; ===========================================================================
        ...
        p2.save, outputpath + '310340_prec001500_x' + string(pixindices[0], format='(i03)') +  $
        ...
        plot_softcal_rad, syntheticwav, l1cradwav, $
          ...
          pixindices[0], pixindices[1], cldstr, suffix='_me001500_310340_adjusted'
...
for icf = 0.05, icf_final, 0.05 do begin
  ...
  ;outputpath = outputpath + 'point_profile/'
      ...
      p2.save, outputpath + 'profile_me001500_310340_x' + string(pixindices[0], format='(i03)') +  $
  ...
  if n_elements(idx) ge 1 then begin
    ...
    for ip = 0, n_elements(idx)-1 do begin
      ...
      if indices[0] eq 91 then begin
        ...
        outfilepath = './plot/synthetic_radiance_diff/'
        pngfile = outfilepath + 'gems_merra2_synthetic_simrad_me001500_ecf' + sicf0 +'-' + sicf1 + $
