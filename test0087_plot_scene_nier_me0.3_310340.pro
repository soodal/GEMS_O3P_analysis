...
for i=0, n_elements(jd_list)-1 do begin
  ...
  fn = '/home/soodal/data/EOSRL/GK2_GEMS_O3P_20210329_0345_20211222T181642+0900_8core_no_testvar_310340_me0.3_NIER.nc'
  ...
  for i = 0, n_elements(filelist)-1 do begin
    ...
    ds_plot_gemso3p_scene, filelist[i], $
        outputpath='./plot/', project='EOSRL', sub='me0.3_310_340_NIER'
  endfor
endfor
