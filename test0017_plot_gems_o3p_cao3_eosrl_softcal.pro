...
L1Cmaker = 'EOSRL'
ntrain = string(3, format='(I02)')

path ='/data1/gems/o3p/ds/GEMS_O3P_Yonsei/' 
outputpath = path + 'out/softcal/'
projectpath = outputpath + fitrange + '_' + L1Cmaker + '_image_mean_' + ntrain + '/'
...
scp_dest = 'soodal@164.125.38.179:/home/soodal/WindowsHome/Pictures/scp/' $
  + 'softcal/' + fitrange + '_' + L1Cmaker + '_image_mean_' + ntrain
