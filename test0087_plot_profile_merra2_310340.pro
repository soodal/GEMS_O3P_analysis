...
;if file_test(datafile) then begin
  ...
  search_str = '/data/private/soodal/EOSRL/EOSRL/GK2_GEMS_L2_O3P_' + $
    datetime_str + '_wli310_ML_prec000000_maxit10_ozminmax2x_BIN4x4.nc'
  ...
  for icity=0, n_elements(cities_lat) -1 do begin
    ...
    if pixidx ne -999 then begin 
      ...
      ; ===========================================================================
        ...
        print, 'leg'
        leg = legend(target=[p2, p4, p5], position=[59, 1.5],/data)
        ...
        print, 'sav'
        outputpath = './plot/merra2_synthetic/310_340/20210329_0345/point_profile/'
        ...
        p2.save, outputpath + '310340_merra2_synthetic_x' + string(pixindices[0], format='(i03)') +  $
