    ...
    if pixidx ne -999 then begin 
      ...
      ; ===========================================================================
        ...
        plot_softcal_rad, syntheticwav, l1cradwav, $
          ...
          pixindices[0], pixindices[1], cldstr, suffix='_me0.2_adj_sig_310340', $
          outfilepath='./plot/EOSRL/me0.2_310_340/'
...
for icf = 0.05, icf_final, 0.05 do begin
  ...
  ;outputpath = outputpath + 'point_profile/'
      ...
      p2.save, outputpath + 'profile_me0.2_adj_sig_310340_x' + string(pixindices[0], format='(i03)') +  $
      ...
      plot_softcal_rad, syntheticwav, l1cradwav, $
        ...
        nier_gems_fitspec, nier_l1cradwav, $
        pixindices[0], pixindices[1], cldstr, suffix='_me0.2_adj_sig_310340', $
        outfilepath='./plot/EOSRL/me0.2_adj_sig_310_340/'
