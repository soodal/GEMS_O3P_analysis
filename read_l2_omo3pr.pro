pro read_l2_omo3pr, file,result
 ...
 gg = '/HDFEOS/SWATHS/O3Profile/Geolocation Fields'
  ...
  o3 = h5read(file, dg+'/AerosolOpticalThickness')
...
;is 0 for not set and 1 for set):
 ...
 result ={groundpqf:groundpqf, $
   lat:lat, lon:lon, $
   sza:sza, saa:saa, vaa:vaa, vza:vza, $
   pqf:pqf, mflag:mflag,$
   rowAnomaly:rowAnomaly, uClimpcld:useClimpcld,$
   toz:toz,$
   o3:o3, o3ap:o3ap, o3aperr:o3aperr, o3prec:o3prec, $
   refcf:refcf, res:res,$
   rmserr:rmserroffit, $
   pc:cloudPressure, $
