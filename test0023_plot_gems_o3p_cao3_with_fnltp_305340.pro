...
outputpath = path + 'out/' + 'fnldailytp/'
projectpath = outputpath + fitrange + '_' + L1Cmaker + '_w_softcal_image_mean/'
...
scp_dest = 'soodal@164.125.38.179:/home/soodal/WindowsHome/Pictures/scp/' $
  + 'dailytpcomparison/' + fitrange + '_' + L1Cmaker + '_w_softcal_image_meano_softcal'
...
plot_gems_satproj, projectpath + fn
stop
