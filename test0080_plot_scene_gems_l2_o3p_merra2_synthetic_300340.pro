...
for i=0, n_elements(jd_list)-1 do begin
  ...
  fn = '/home/soodal/data/softcal_test/corrected/model_300_340/GK2_GEMS_L2_O3P_20210329_0345_winliminit300_prec000000_climML_b4x4_o20211221T225814Z_clima_maxiter10_ecf0.nc'
  ...
  for i = 0, n_elements(filelist)-1 do begin
    ...
    ds_plot_gemso3p_scene, filelist[i], $
        outputpath='./plot/', project='merra2_synthetic', sub='300_340'
  endfor
endfor
