...
;for i=0, n_elements(jd_list)-1 do begin
  ...
  fn = '/home/soodal/data/SURFPRES_TEST/2x_ozmin_ozmax_fnl_daily/GK2_GEMS_L2_O3P_20210621_0345_wli310_ML_prec000000_maxit10_ozminmax2x_BIN4x4.nc'
  ...
  for i = 0, n_elements(filelist)-1 do begin
    ...
    ds_plot_gemso3p_scene, filelist[i], $
        outputpath='./plot/', project='SURFPRES_TEST', sub='climML_310_340_surfpresUM'
  endfor
;endfor
