pro ds_plot_gemsl2cld_scene, gemsfile, outputpath=outputpath, project=project, sub=sub
...
if fileok then begin 
  ...
  ecfge02 = ecf
  clrind = where(ecf lt 0.2, /null)
  ecfge02[clrind] = !values.f_nan

  plot_sat_proj, ecfge02, longitude, latitude, $
    title='GEMS L2 CLD EffectiveCloudFraction >= 0.2 ' + datetime_str, $
    range=[0.2, 1.], $
    pngfile=outputpath + '04_ecf_ge_0.2.png';, $
