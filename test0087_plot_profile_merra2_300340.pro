  ...
  for icity=0, n_elements(cities_lat) -1 do begin
    ...
    if pixidx ne -999 then begin 
      ...
      ; ===========================================================================
        ...
        print, 'sav'
        outputpath = './plot/merra2_synthetic/300_340/20210329_0345/point_profile/'
        ...
        p2.save, outputpath + '300340_merra2_synthetic_x' + string(pixindices[0], format='(i03)') +  $
