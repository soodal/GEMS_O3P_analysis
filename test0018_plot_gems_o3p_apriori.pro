...
L1Cmaker = 'EOSRL'
ntrain = string(2, format='(I02)')

path ='/data1/gems/o3p/ds/GEMS_O3P_Yonsei/' 
outputpath = path + 'out/305340_EOSRL/'
...
o3apriori = data.O3Apriori
o3apErr = data.O3AprioriError
...
for i=0, nlayer-1 do begin
  iO3aprioriError = reform(o3apriori[i, *, *], dim)
  o3layer_geolocidx = where(lon gt 0 and lat gt 0 and iO3aprioriError gt 0, /null)
  ...
  ct = colortable(74, /reverse)
  mag = bytscl(iO3aprioriError[o3layer_geolocidx], min=zrange[0], max=zrange[1])
  p1 = scatterplot(lon[o3layer_geolocidx], lat[o3layer_geolocidx], $
    ...
    symbol='dot', $
    sym_size=0.7, $
    title='O3 A priori ' + strpres + 'hPa (mean) EOSRL L1C ' + fit_range + ' nm fitting', $
    axis_style=0)
  ...
  t = text(0.4, 0.025, 'Dae Sung Choi, ' + isodate)
  pngfile = './plot/gems_l2_o3_apriori_error_' + fitrange + '_' + L1Cmaker + '_' +strpres+'.png'
...
for i=0, nlayer-1 do begin
  iO3apriori = reform(o3apriori[i, *, *], dim)
  o3layer_geolocidx = where(lon gt 0 and lat gt 0 and iO3apriori gt 0, /null)
  ...
  ct = colortable(74, /reverse)
  mag = bytscl(iO3apriori[o3layer_geolocidx], min=zrange[0], max=zrange[1])
  p1 = scatterplot(lon[o3layer_geolocidx], lat[o3layer_geolocidx], $
    magnitude=mag, /buffer, $
    overplot=map, $
    rgb_table=ct, $
  ...
  t = text(0.4, 0.025, 'Dae Sung Choi, ' + isodate)
  pngfile = './plot/gems_l2_o3_apriori_' + fitrange + '_' + L1Cmaker + '_' +strpres+'.png'
