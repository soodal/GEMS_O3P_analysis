...
;if file_test(datafile) then begin
  ...
  ; GEMS O3P NIER
  ;=============================================================================
  search_str = '/data/private/soodal/EOSRL/NIER/GK2_GEMS_L2_O3P_20210329_0345_wli310_ML_prec000000_adj_sig_0.2_ozminmax2x_NIER_BIN4x4.nc'
  search_str = '/data/private/soodal/EOSRL/NIER/GK2_GEMS_L2_O3P_20210329_0345_wli310_ML_prec000000_ozminmax2x_NIER_BIN4x4.nc'
  ...
  ; GEMS O3P EOSRL 1x1
  ;=============================================================================
  ;search_str = '/data/private/soodal/EOSRL/EOSRL/GK2_GEMS_L2_O3P_20210329_0345_wli310_ML_prec000000_adj_sig_0.2_ozminmax2x_EOSRL_BIN4x4.nc'

  search_str = '/data/private/soodal/EOSRL/310340/GK2_GEMS_L2_O3P_20210329_0345_wli310_ML_prec000000_0.5_ozminmax2x_BIN4x4_fitspec1.6.nc.debug.nc'
  search_str = '/data/private/soodal/EOSRL/310340/GK2_GEMS_L2_O3P_20210329_0345_wli310_ML_prec000000_0.5_ozminmax2x_BIN4x4.nc.debug.nc'
  search_str = '/data/private/soodal/test/1x1_debug/GK2_GEMS_L2_O3P_20210329_0345_wli310_ML_prec000000_0.5_ozminmax2x_BIN4x4.nc.debug.nc'
  fl = file_search(search_str)

  eosrl_data = ds_read_gems_l2_o3p(fl[-1])

  ;lat = eosrl_data.latitude
  ;lon = eosrl_data.longitudel
  ...
  ;for icity=0, n_elements(cities_lat) -1 do begin
    ...
    ;if pixidx ne -999 then begin 
      ...
      ;; ===========================================================================
        ...
        ;endif
        ;p2.save, outputpath + '310340_prec0.2_adj_sig_x' + string(pixindices[0], format='(i03)') +  $
        ...
        ;plot_softcal_rad, syntheticwav, l1cradwav, $
          ...
          ;pixindices[0], pixindices[1], cldstr, suffix='_me0.2_adj_sig_310340_debug', $
          ;outputpath='./plot/EOSRL/me0.2_310_340_debug/'
...
pixindices = [91, 376]
eosrl_pixindices = [368, 1508]

; ===========================================================================
; plotting profile for a pixel
; ===========================================================================
...
eosrl_pres = reform(eosrl_data.pressure[eosrl_pixindices[0], eosrl_pixindices[1], *])
eosrl_pres = exp((alog(eosrl_pres[0:-2]) + alog(eosrl_pres[1:-1]))/2.)
...
eosrl_ozprof = eosrl_o3p[eosrl_pixindices[0], eosrl_pixindices[1], *]
print, 'p3'
p3 = plot(eosrl_ozprof, eosrl_pres[0:23], /buffer, /overplot);, $ color='#e4a000', linestyle=1, name='Ozonesonde with GEMS O3P AVGK', /overplot)
;p3.color = [228, 160, 0]
...
p2.save, outputpath + 'point_profile/profile_me0.5_310340_x' + string(pixindices[0], format='(i03)') +  $
    '_y' + string(pixindices[1], format='(i03)')  + '_1x1_debug.png'
p2.close
...
;plot_softcal_rad, syntheticwav, l1cradwav, $
  ...
  ;nier_gems_fitspec, nier_l1cradwav, $
  ;pixindices[0], pixindices[1], cldstr, suffix='_me0.2_adj_sig_310340_debug', $
  ;outputpath='./plot/EOSRL/me0.2_adj_sig_310_340_debug/'
...
indices = [91, 376]
  ...
  eosrl_gems_fitspec_ratio = (eosrl_gems_fitspec[indices[0], indices[1], *] - $
  ...
  ;data[idx] = 0
  p4 = barplot($
    syntheticwav[indices[1], *], eosrl_gems_fitspec_ratio, $
    /buffer, $
    axis_style=0, $
  ...
  ;outputpath='./plot/EOSRL/me0.5_310_340_debug/'
  if not file_test(outputpath) then begin
    file_mkdir, outputpath
  endif
  pngfile = outputpath + 'gems_merra2_synthetic_simrad_me0.5_ecf' + $
    '_x' + string(indices[0], format='(i03)') + $
    '_y' + string(indices[1], format='(i03)') + '_1x1_debug.png'
...
for icf = 0.05, icf_final, 0.05 do begin
  ...
  if n_elements(idx) ge 1 then begin
    ...
    for ip = 0, n_elements(idx)-1 do begin
      ...
      outputpath = './plot/synthetic_radiance_diff/'
      pngfile = outputpath + 'gems_merra2_synthetic_simrad_ecf' + sicf0 +'-' + sicf1 + $
        '_x' + string(indices[0], format='(i03)') + $
  ...
  ;outputpath = './plot/synthetic_radiance_diff/'
  ;pngfile = outputpath + 'gems_merra2_synthetic_simrad_ecf' + sicf0 +'-' + sicf1 + '.png'
  ;;p1.errorbar_color='indian_red'
  ;;p1.errorbar_capsize=0.1
  ;;p1.title.font_size=16
  ;p_.save, pngfile
...
syidx = string(ypos, format='(i03)')
outputpath = '/home/soodal/works/GEMS_O3P_analysis/plot/synthetic_radiance_diff/'
pngfile = outputpath + 'gems_merra2_synthetic_simrad_y' +sYidx + '.png'
print, pngfile
;p1.errorbar_color='indian_red'
;p1.errorbar_capsize=0.1
