...
gemsfile = '/home/soodal/data/softcal_test/raw/model_300_340/GK2_GEMS_L2_O3P_20210621_0345_winliminit300_prec000000_climML_b4x4_o20210926T114307Z_clima_maxiter10.nc'
gemsfile = '/home/soodal/data/softcal_test/raw/model_310_340/GK2_GEMS_L2_O3P_20210621_0345_winliminit310_prec000000_climML_b4x4_o20210930T201932Z_clima_maxiter10_ecf0.nc'

gems_basename = file_basename(gemsfile)


project = 'softcal_test'
...
cldvar = ds_read_gems_l2_cld('/data/private/soodal/ln/GEMS/L2CLD/GK2_GEMS_L2_CLD_20210621_0345_4x4.nc')

;=============================================================================
; READ MERRA2
;=============================================================================

merra2 = ds_read_merra2_tavg3_3d_asm_nv_collocated_on_gems_l1c('/data/private/soodal/MERRA2_collocated_on_gems/merra2_tavg3_3d_asm_collocated_on_gemsl1c_rad_20210621_0345.nc4')
...
if okay then begin
  for ipix = 0, n_elements(xidx)-1 do begin
    ...
    merra2_ozprof = merra2_o3_on_gems_o3[xidx[ipix], yidx[ipix], *]
