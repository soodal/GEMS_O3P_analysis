...
scp_dest = 'soodal@164.125.38.179:/home/soodal/WindowsHome/Pictures/scp/' $
  ;+ 'softcal/' + fitrange + '_' + L1Cmaker + '_image_mean_sum_tropo'
  + 'ml_clima/' + fitrange + '_' + L1Cmaker + '_sum_tropo'
...
p1 = scatterplot(lon[o3total_geolocidx], lat[o3total_geolocidx], $
  ...
  symbol='dot', $
  sym_size=0.7, $
  title='Total Column Amount O3 ' + L1Cmaker + ' L1C ' + fit_range + ' nm fitting', $
  axis_style=0)
...
pngfile = './plot/gems_l2_cao3_ml_clima_' + fitrange + '_' + L1Cmaker +'.png'
...
p1 = scatterplot(lon[o3strato_geolocidx], lat[o3strato_geolocidx], $
  ...
  symbol='dot', $
  sym_size=0.7, $
  title='Stratospheric Column Amount O3 ' + L1Cmaker + ' L1C ' + fit_range + ' nm fitting', $
  axis_style=0)
...
t = text(0.4, 0.025, 'Dae Sung Choi, ' + isodate)
pngfile = './plot/gems_l2_o3strato_ml_clima_' + fitrange + '_' + L1Cmaker + '.png'
...
p1 = scatterplot(lon[o3tropo_geolocidx], lat[o3tropo_geolocidx], $
  ...
  symbol='dot', $
  sym_size=0.7, $
  title='Troposheric Column Amount O3 ' + L1Cmaker + ' L1C ' + fit_range + ' nm fitting', $
  axis_style=0)
...
t = text(0.4, 0.025, 'Dae Sung Choi, ' + isodate)
pngfile = './plot/gems_l2_o3tropo_ml_clima_' + fitrange + '_' + L1Cmaker + '.png'
...
; under 300 hPa
o3tropo_accum = total(o3[21:23, *, *], 1)



o3layer_geolocidx = where(lon gt 0 and lat gt 0 and o3tropo_accum gt 0, /null)

iPres = reform(pres[21, *, *], dim)
...
ct = colortable(74, /reverse)
mag = bytscl(o3tropo_accum[o3layer_geolocidx], min=zrange[0], max=zrange[1])
p1 = scatterplot(lon[o3layer_geolocidx], lat[o3layer_geolocidx], $
  ...
  symbol='dot', $
  sym_size=0.7, $
  title='O3 ' + strpres + '-1000 hPa (sum) ' + L1Cmaker + ' L1C ' + fit_range + ' nm fitting', $
    axis_style=0)
...
t = text(0.4, 0.025, 'Dae Sung Choi, ' + isodate)
pngfile = './plot/gems_l2_cao3_ml_clima_' + fitrange + '_' + L1Cmaker + '_'+strpres+'-1000hPa_sum.png'
