;==============================================================================
;
; Plot data from GEMS L2 O3P output file
;
; PROGRAM NAME:
; 
;
...
;   Devision of Earth Environment Science
...
pro ds_plot_gems_l2_o3p_subdata, gemsl2fn, varname=varname, outputpath=outputpath, scppath=scppath
